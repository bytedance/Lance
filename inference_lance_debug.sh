...
TASK_NAME=${TASK_NAME:-t2i} # t2i | image_edit | t2v | i2v | video_edit | x2t_image | x2t_video
...
RESOLUTION=${RESOLUTION:-"image_768res"}   # image_768res | video_480p
TEXT_TEMPLATE=${TEXT_TEMPLATE:-true}

MODEL_PATH=${MODEL_PATH:-"outputs/huangmengqi_sft_lance/v0608_4x2_t2i/checkpoints/0005000"}
