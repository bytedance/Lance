...
VAE_MODEL_TYPE="wan"
VISUAL_UND=True
VISUAL_GEN=False # True，如果只有理解任务，关闭生成任务
...
# ==============================数据配置==============================
DATASET_CONFIG_FILE=${DATASET_CONFIG_FILE:-config/train_local/multi_und.yaml}
VAL_DATASET_CONFIG_FILE=${VAL_DATASET_CONFIG_FILE:-config/train_local/multi_und.yaml}
